...
CB_color_cycle = ['#377eb8', '#ff7f00', '#4daf4a', '#f781bf', '#a65628', '#984ea3', '#e41a1c']
color_other = '#dede00'
common_protocols = ["MODBUS", "IEC60870_5_104", "FOX", "S7", "WDBRPC", "BACNET", "EIP"] # top 7 with most devices
...
def draw_top_proportions(countries, top_countries, output_file):
    ...
    plt.legend(labels=common_protocols + ['Other'], bbox_to_anchor=(1.02, -0.063), ncol=4)

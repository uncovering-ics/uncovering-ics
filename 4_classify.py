...
def classify(indications):
    ...
    # If we have observed honeypot signatures, it's definitely a honeypot
    if any(x in indications for x in ['honeypot_defaults_conpot', 'honeypot_defaults_snap7', 'gaspot_newlines', 'gaspot_date']):

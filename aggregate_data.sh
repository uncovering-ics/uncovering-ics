...
cat "${aggregated_dir}/all_final.tmp.json" | jq '.[] | select(.indications | any(index("classification_honeypot") or index("classification_likely_honeypot")))' | jq -s > "${aggregated_dir}/all_final_honeypot.tmp.json"
cat "${aggregated_dir}/all_final.tmp.json" | jq '.[] | select(.indications | any(index("classification_potentially_real")))' | jq -s > "${aggregated_dir}/all_final_real.tmp.json"
cat "${aggregated_dir}/all_final_honeypot.tmp.json" | jq '.[] | select(.protocol != "WDBRPC")' | jq -s > "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json"
...
echo "Generating classifications per country map and plot excluding WDBRPC"
./other/classifications_per_country_map.py <(cat "${aggregated_dir}/all_final.tmp.json" | jq '.[] | select(.protocol != "WDBRPC")' | jq -s) "$aggregated_dir/classifications_per_country_excl_WDBRPC.pdf" "$aggregated_dir/classifications_per_country_top15_excl_WDBRPC.pdf" > /dev/null
...
echo "Generating per-protocol open port cdf for honeypots excluding WDBRPC"
./other/protocol_open_port_cdf.py "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json" "${aggregated_dir}/protocol_open_port_cdf_honeypot_excl_WDBRPC.pdf" dashed
...
echo "Generating AS type host count cdf cdf for honeypots excluding WDBRPC"
./other/as_type_count_cdf.py "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json" "${aggregated_dir}/as_type_count_cdf_honeypot_excl_WDBRPC.pdf"
...
echo "Generating honeypot country pie chart excluding WDBRPC"
./other/country_pie_chart.py "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json" "${aggregated_dir}/pie_chart_country_honeypot_excl_WDBRPC.pdf"
...
echo "Generating honeypot company type pie chart excluding WDBRPC"
./other/company_type_pie_chart.py "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json" "${aggregated_dir}/pie_chart_company_type_honeypot_excl_WDBRPC.pdf"
...
echo "Generating honeypot AS pie chart excluding WDBRPC"
./other/as_pie_chart.py "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json" "${aggregated_dir}/pie_chart_as_honeypot_excl_WDBRPC.pdf"
...
echo "Generating honeypot distribution map excluding WDBRPC"
./other/total_per_country_map.py "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json" "YlOrRd" "${aggregated_dir}/total_per_country_honeypot_excl_WDBRPC.pdf"
...
echo "Generating honeypot protocol popularity map excluding WDBRPC"
./other/protocol_popularity_map.py "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json" "${aggregated_dir}/protocol_popularity_honeypot_excl_WDBRPC.pdf" "${aggregated_dir}/protocol_popularity_top10_honeypot_excl_WDBRPC.pdf" > /dev/null
...
echo "Generating asdb_category_stats.txt"
./other/asdb_category_stats.py "${aggregated_dir}/all_final.tmp.json" > "${aggregated_dir}/asdb_category_stats.txt"
...
echo "Generating honeypot protocol count excluding WDBRPC"
./other/protocol_count.py "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json" honeypot "${aggregated_dir}/protocol_count_honeypot_excl_WDBRPC.pdf"
...
echo "Generating honeypot AS protocol count excluding WDBRPC"
./other/protocol_count_as.py "${aggregated_dir}/all_final_honeypot_excl_WDBRPC.tmp.json" honeypot "${aggregated_dir}/protocol_count_as_honeypot_excl_WDBRPC.pdf"
